...
INSERT INTO gram_dtl_n1 VALUES(null, '～あげくに（の）', '　　［动词过去形；体言の］＋　あげくに／～的结果；最后～（多用于后果不好或消极的场合）
...
INSERT INTO gram_dtl_n1 VALUES(null, '～あっての', '　　［体言］＋　あっての／有了～才有～

例：1、あなたあっての私です。あなたがいなければ今日の私はいない。／有了你才有我．没有你就不可能有今天的我．

　　2、この子ってのわが家。もしこの子がいなかったらと思うと・・・／有了这个孩子才有我家．想到如果没有这孩子就．．．');
INSERT INTO gram_dtl_n1 VALUES(null, '～いかんだ', '　［体言］＋いかんだ／取决于～；根据～而定
...
INSERT INTO gram_dtl_n1 VALUES(null, '～いかんで', ' ［体言］＋いかんで（或いかんによって）／根据～而～；根据～来～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～いかんにかかわらず', '　［体言の］＋いかんにかかわらず／不管～；不论～

例：1，成否のいかんにかかわらず、やってみることだ。／不管成败与否，都要做起来看．');
INSERT INTO gram_dtl_n1 VALUES(null, '～いかんによっては', '　［体言］＋いかんによっては　（或いかんでは）由于～（情况）不同～；根据～如何～

例：1、やり方いかんによっては結果も違ってくる。／由于做法不同．．．结果也不同．

　　2、実験の結果いかんによっては研究を中止する可能性もある。／根据实验结果如何，也于可能中止研究．');
INSERT INTO gram_dtl_n1 VALUES(null, '～いかんによらず', '　　［体言の］＋いかんによらず／不管～；不论～

例：1、対応のいかんによらず、こちらは自分のやり方でやっていく。／不论对方如何应付，我们都要按自己的想法而定的．');
INSERT INTO gram_dtl_n1 VALUES(null, '～以上は', '　［形容词连体形］＋以上は　／既然～（当然）就～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～て（は）いられない', '　［动词连用形］＋て（は）いられない／不能～；哪能～　表示动作的主体在心情上无法再保持原来的某种状态．

例：1、急ぐので、明日まで待ってはいられません。／因为很急，所以不能等到明天．

　　2、ミンナ働いているので、私だけがそばで休んではいられません。／大家都在工作，我不能一人在一旁休息．');
INSERT INTO gram_dtl_n1 VALUES(null, '～う（よう）が', '［动词未然形］＋う（よう）が／无论～都～  

例：1、どんな金持ちであろうが、幸福は金で買えるものではない。／无论多么有钱，幸福是金钱买不到的．');
INSERT INTO gram_dtl_n1 VALUES(null, '～う（よう）が、～まいが', '［动词未然形］＋う（よう）が，［五段动词终止形；其他动词，助词未然形］＋まいが／不论是～还是不～；不管是否～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～う（よう）と、～まいと', '　［动词未然形］＋う（よう）と、，［五段动词终止形；其他动词未然形］＋まいと／不管是～还是～

例：1、仕事が終ろうと終るまいと、時間になれば私は帰る。／不管工作完没完，到点我就走．');
INSERT INTO gram_dtl_n1 VALUES(null, '～よ（よう）にも～ない', '　　［动词未然形］＋う（よう）にも、［同一动词可能式］＋ない／想～也（不）～

例：1、いまさら、あんな遠いところへはいこうにもいけない。／到现在了，那么远的地方，想去也去不成了．

　　2、全く自業自得（じごうじとく）だ、今になって、泣こうにも泣けない。／真是自作自受，到现在，想哭都哭不出来．');
INSERT INTO gram_dtl_n1 VALUES(null, '～う（よう）ものなら', '　［动词未然形］＋う（よう）ものなら／如果～可～；只要～就～（表示强烈的假定条件，后果一般不好）
...
INSERT INTO gram_dtl_n1 VALUES(null, '～得（う）る', '［动词连用形］＋～得（う）る／能够～；可以～［过去式读作＂得（え）た＂，否定式读作＂得（え）ない＂］
...
INSERT INTO gram_dtl_n1 VALUES(null, '～おそれがある', '　［动词连体形；体言］＋おそれがある/有～的危险；恐怕要～；有可能～（结果多为消极）
...
INSERT INTO gram_dtl_n1 VALUES(null, '～かけだ', '［动词连用形］＋かけだ／表示动作刚开始，动作未完而中断，动作即将发生等．

例：1、もう　出勤の時間なのに　まだ　御飯が食べかけだ。／已经到了上班时间，但饭还没吃完．');
INSERT INTO gram_dtl_n1 VALUES(null, '～かけの', '［动词连用形］＋かけの／表示动作刚开始，动作未完而中断，动作即将发生等．

例：1、読みかけの雑誌を電車の中に置き忘れてきた。／把没有读完的杂志遗忘在电车上了．

　　2、腐れかけの肉を捨てた。／把开始腐烂的肉仍了．');
INSERT INTO gram_dtl_n1 VALUES(null, '～がたい', '［动词连用形］＋がたい／难于～；不容易～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～かたがた', '　　［体言］＋かたがた／顺便～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～かたわら', '　　［动词连体形；体言の］＋かたわら／一边～一边～；一面～一面～

例：1、家にいたとき、勉強のかたわら、家事を手伝っていました。／在家的时候，边学习，边帮着做家务．

　　2、私は仕事をするかたわら、コンピューターの勉強をしている。／我一面工作，一面学习电脑．');
INSERT INTO gram_dtl_n1 VALUES(null, '～がてら', '　　［动词连用形；体言］＋がてら（に）／～的时候，顺便～；～的同时～ 
...
INSERT INTO gram_dtl_n1 VALUES(null, '～かと思うと（思ったら）', '　　［动词，形容词终止形；形容词词干；体言］＋かと思うと（或～かと思ったら）／刚一～（马上）就～；本以为～不料想～；忽而～忽而～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～か～ないかのうちに', '　　［动词终止形］＋か［同一动词未然形］ないかのうちに（或：ないうちに）／刚要～就～；刚一～就～

例：1、彼女はそういったかいわないかのうちに泣き出した。／她刚要说就哭起来了．

　　2、彼は汽車が止まるか止まらないうちに飛び下りた。／火车刚一停，他就跳下车了．');
INSERT INTO gram_dtl_n1 VALUES(null, '～かねる（～かねない）', '　　［动词连用形］＋かねる／难以～；不便～；不能～；不好意思～ 
...
INSERT INTO gram_dtl_n1 VALUES(null, '～が早いか', '　［动词连体形］+が早いか/刚一～就～

例：1、弟は部屋に入るが早いか、かばんを放り投げた遊びに行った。／弟弟刚一进屋，就扔下书包玩去了．

　　2、彼は起きるが早いか部屋を飛び出した。／他刚一起床，就跑出了房间．');
INSERT INTO gram_dtl_n1 VALUES(null, '～からある（からの）', 'らある（からの）
...
INSERT INTO gram_dtl_n1 VALUES(null, '～からして', '［体言］＋からして／从～来看；从～就～；不用说别的，就从～
...
INSERT INTO gram_dtl_n1 VALUES(null, '～からすると', '　　［体言］＋からすると（或：～からすれば）／以～来看；就～来说；根据～（来判断，衡量等）
...
INSERT INTO gram_dtl_n1 VALUES(null, '30', '30');
